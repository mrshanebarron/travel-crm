<aside class="w-64 sidebar fixed h-screen">
    <div class="p-6">
        <div class="flex items-center gap-3 mb-8">
            <img src="{{ asset('images/tapestry_logo.jpg') }}" alt="Tapestry of Africa" class="h-12 w-auto rounded">
        </div>
        ...
        <nav class="space-y-2">
            ...
            <a href="{{ route('reconciliation.index') }}" class="sidebar-link {{ request()->routeIs('reconciliation.*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
